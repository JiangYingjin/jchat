...
- 用户输入预处理：详情请看 [https://github.com/Yidadaa/ChatGPT-Next-Web/issues/2144](https://github.com/Yidadaa/ChatGPT-Next-Web/issues/2144)
...
1. 历史摘要：作为长期记忆，提供长久但模糊的上下文信息；
2. 预设提示词：当前对话内设置的预设提示词，用于 In-Context Learning 或者注入系统级限制；
3. 最近 n 条对话记录：作为短期记忆，提供短暂但精确的上下文信息；
4. 用户当前输入的消息。
